...
const Header = () => {
  ...
  const navItems = [
    { href: '/', label: 'Work' },
    { href: '/artist-statement', label: 'Artist Statement' },
    ...
    <header className="sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link 
            href="/" 
            className="text-xl font-serif font-medium hover:text-white/80 transition-colors duration-200 focus-ring"
          >
            Chan Riiny
          </Link>
          ...
          {/* Mobile Menu Button */}
          <button
            className="md:hidden p-2 text-white/70 hover:text-white transition-colors duration-200 focus-ring"
